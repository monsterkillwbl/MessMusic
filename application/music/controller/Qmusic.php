...
class Qmusic extends Controller{
    public function Music(){
        ...
        if($get['type']=='lrc'){
            // 请求地址
            $url = 'https://c.y.qq.com/qzone/fcg-bin/fcg_mv_getinfo_bysongid.fcg?utf8=1&mids='.$id.'&uin=10000&p=0.2942163181853784&g_tk=1827372749&jsonpCallback=JsonCallback&loginUin=31639971&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0';
